...
INSERT INTO GAMA_PRODUCTO (Nombre_gama, Descripcion_gama) VALUES
('Plantas', 'Plantas ornamentales y de interior'),
('Árboles', 'Árboles frutales y decorativos'),
('Flores', 'Flores de temporada y perennes'),
('Macetas', 'Macetas de barro, plástico y cerámica'),
('Sustratos', 'Tierra, abonos y fertilizantes'),
('Herramientas', 'Herramientas de jardinería manuales'),
('Riego', 'Sistemas de riego y mangueras'),
('Decoración', 'Elementos decorativos para jardín'),
('Semillas', 'Semillas para huertos y jardines'),
('Césped', 'Pasto natural y artificial');
select * from GAMA_PRODUCTO;
