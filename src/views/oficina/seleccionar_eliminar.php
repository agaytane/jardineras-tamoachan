<div class="contenedor-vista">
    <div class="encabezado-pagina">
        <h1>🗑️ Eliminar Oficina</h1>
        <p class="subtitulo">Selecciona la oficina que deseas eliminar</p>
    </div>
    ...
    <div class="tarjeta-formulario">
        <div style="background: linear-gradient(135deg, #ffe6e6 0%, #f9d4d4 100%); border-left: 5px solid #ff3b30; padding: 20px; border-radius: 8px; margin-bottom: 30px;">
            ...
            <p style="color: #666; margin: 0;">Esta acción eliminará permanentemente la oficina seleccionada. Esta operación no se puede deshacer.</p>
        </div>

        <form action="/OFICINAS/ELIMINAR" method="POST" onsubmit="return confirm('¿ Está completamente seguro de eliminar esta oficina? Esta acción es PERMANENTE.')">
            <div class="grupo-formulario">
                <label class="etiqueta-formulario">
                    Oficina a eliminar <span class="requerido">*</span>
                </label>
            ...
            <div class="contenedor-botones">
                <button type="submit" class="btn-accion btn-danger">🗑 Eliminar Oficina</button>
